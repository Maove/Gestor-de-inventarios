...
public class PanelAgregarEquipo extends JFrame
{
	...
	public PanelAgregarEquipo()
	{
		...
		txtNombre.setToolTipText("Nombre del equipo a agregar");
		
		txtCantidad = new JTextField();
		txtCantidad.setToolTipText("Cantidad del equipo a agregar");
